...
export default function AddProduct() {
   ...
   /*    try {
    ...
    <div className='flex flex-row justify-center my-2'><Button onClick={() => {
    ...
    }} className="mx-auto">{isUploading?  "Changer l'image" : "Choisir l'image" }</Button></div>
        </div>
        ...
        {previewImages.length == 0 && <div className="mx-auto w-1/2"> <Button type={"button"}  > Ajouter d'autres images </Button> </div>}
          ...
          <div className="absolute top-2 right-2 z-10">
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                        ...
                        if(res.isConfirmed && res.value){ 
                           let form = new FormData()
                            ...
                            axios.post("/api/upload", form).then((res) => {
                              ...
                              if(product && typeof product.otherImagesUrl !== "undefined"){
                ...
                <DropdownMenuItem>Ajouter une image</DropdownMenuItem>
